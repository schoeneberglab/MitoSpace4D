...
class Lightweight3DResNet(nn.Module):
    def __init__(self, embedding_size=2048, cfg=None, apply_aug=False, decoder_checkpoint_path=None):
        ...
        self.with_decoder = decoder_checkpoint_path if decoder_checkpoint_path is not None else None
    ...
    def forward(self, x):
        ...
        # EXPERIMENT for Cancer PTEN Data trial 3b
...
if __name__ == '__main__':
    ...
    model = Lightweight3DResNet(embedding_size=2048, cfg=cfg,
                                 apply_aug=True).cuda()
