...
def validate_saved_model(model_path, device=None, 
    ...
    for volume_id , filepath in enumerate(cfg.val_filepaths_2):
        try:
            ...
            for t_idx_in_file in range(time_points):
                ...
                video_clip_for_z = current_data_tensor[6:z_all-6:3, :, t_idx_in_file, :, :]
    ...
    # set label mapping
    num_labels = 2
    max_z = time_points # this assumes all files are of similar z length
...
if __name__ == "__main__":
    ...
    cfg.save_path = "ckpt_10_drugs_t_slices_"
