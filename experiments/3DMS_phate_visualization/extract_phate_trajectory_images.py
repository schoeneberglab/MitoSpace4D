...
if __name__ == '__main__':
    ...
    save_dir = osp.join(proj_dir, "visualizations/kinetics_phate_trajectory_images")
    ...
    for label in pick_labels:
        ...
        for region in range(min_region, max_region + 1):
            ...
            img = img_4d[0, 1, ...].max(axis=0)  # MIP: Time 0, Channel 1, project Z

            outfile = f"{lbl}_{label_name}_t{time}_r{region}.png"
            ...
            # Save as PNG
            imageio.imwrite(save_path, img_color)