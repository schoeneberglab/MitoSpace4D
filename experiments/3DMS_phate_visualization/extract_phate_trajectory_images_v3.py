...
if __name__ == '__main__':
    ...
    save_dir = osp.join(proj_dir, "../../kinetics_phate_trajectory_images4_n10_stride60")
    ...
    for label in pick_labels:
        ...
        # # Sample trajectories
        # candidates = df_label.iloc[::sample_interval].head(n_images)
        ...
        for sample_time in sample_times:
            ...
            img = img_4d[1, frame_idx, ...].max(axis=0)  # MIP: Channel 1, Time frame_idx, project Z
