...
if __name__ == "__main__":
    ...
    if already_have_embeddings:
        ...
        train_embeddings, train_images, train_labels, train_im_paths = (
        ...
        eval_embeddings, eval_images, eval_labels, eval_im_paths = (
            extract_embeddings_from_model(
                eval_loader,
                model.model,
                normalize_embeddings=True,
    ...
    all_embeddings_reduced = reducer.fit_transform(
        all_embeddings.reshape(all_embeddings.shape[0], -1)
    )
    all_embeddings_reduced = (
        all_embeddings_reduced / np.linalg.norm(all_embeddings_reduced, axis=1)[:, None]
    )
