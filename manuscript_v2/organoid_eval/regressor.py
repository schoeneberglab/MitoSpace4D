...
def evaluate_and_plot(model, X_val, y_val, target_scaler):
    ...
    plt.title(f'TMRM Intensity Prediction Results (R²: {r2:.4f})')
    # plt.title(f'Morphology Intensity Prediction Results (R²: {r2:.4f})')
...
if __name__ == "__main__":
    # embeddings = np.load("/home/earkfeld/Projects/MitoSpace4D/adaptors/tmrm_regressor/2024v2_embeddings.npy")
    # embeddings = np.load("/home/earkfeld/Projects/MitoSpace4D/adaptors/tmrm_regressor/2024v2_embeddings_resnet.npy")
    ...
    # tmrm_intensities = np.load("/home/earkfeld/Projects/MitoSpace4D/adaptors/tmrm_regressor/2024v2_tmrm_otsu.npy")
    ...
    # Kinetics 3D
    # workdir = "/home/earkfeld/Projects/MitoSpace4D/runs/20260116_kinetics-raw_kinetics-resnet3d_ablated_tmrm_extract_tmrm/"

    # Kinetics 4D
    # workdir = "/home/earkfeld/Projects/MitoSpace4D/runs/20260117_kinetics-4D-embeddings_2024v2-161eps_ablated-tmrm"

    # 2024v2 3D
    # workdir = "/home/earkfeld/Projects/MitoSpace4D/runs/20260117_2024v2-raw_kinetics-resnet3d_ablated_tmrm_extract_tmrm"

    # 2024v2 4D
    workdir = "/home/earkfeld/Projects/MitoSpace4D/runs/20260117_2024v2-4D-embeddings_2024v2-161eps_ablated-tmrm"
    ...
    tmrm_intensities = np.load(osp.join(workdir, "morph_intensities.npy"))
