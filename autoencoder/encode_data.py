...
if __name__ == '__main__':
    ...
    runner = AutoEncoderRunner.load_from_checkpoint(checkpoint_path, model=model)
    runner.model.eval()
    ...
    dataset = MitoSpaceAutoEncoderDataset(data_root)
    dataloader = DataLoader(dataset, batch_size=2, num_workers=8, pin_memory=True, persistent_workers=True,
                            shuffle=False)
