...
class MitoSpace3DEncoderHigherParams(nn.Module):
    def __init__(self, input_dim=2):
        super(MitoSpace3DEncoderHigherParams, self).__init__()
...
class MitoSpace3DDecoderHigherParams(nn.Module):
    def __init__(self, output_dim=2):
        super(MitoSpace3DDecoderHigherParams, self).__init__()
...
class MitoSpace3DAutoencoderHigherParams(nn.Module):
    def __init__(self):
        super(MitoSpace3DAutoencoderHigherParams, self).__init__()
        self.encoder = MitoSpace3DEncoderHigherParams()
        self.decoder = MitoSpace3DDecoderHigherParams()
...
if __name__ == '__main__':
    batch_size = 1
    autoencoder = MitoSpace3DAutoencoderHigherParams().cuda()
