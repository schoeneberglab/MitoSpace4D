...
class Config:
    master_base_path: str = "/media/mayunagupta/easystore/MitoSpace4D/data/2024_data/processed_data/"
    create_third_channel: bool = True 
    use_only_mitotracker: bool = True
    model_name: str = "MCG-NJU/videomae-base"
    image_processor_name: str = "MCG-NJU/videomae-base"
    test_size_z: float = 0.3
    batch_size: int = 16
    num_epochs: int = 20
    ...
    device: str = "cuda:0"
    save_path: str = "checkpoint_combined_drugs"
...
def train_z_predictor_with_custom_loss(cfg):
    ...
    num_files = len(cfg.image_filepaths[0:300])
...
if __name__ == "__main__":
    ...
    cfg.image_filepaths = []
    cfg.val_filepaths = []
    for base_path in cfg.base_paths:
        files = sorted(os.listdir(base_path))
        for i in files[0:30]:
